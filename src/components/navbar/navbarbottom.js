        ...
        <section id="bottom-navigation" className="block fixed inset-x-0 bottom-0 z-10 bg-white shadow">
            <div id="tabs" className="flex justify-between">
                ...
                <Link to={"#"} className="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center pt-2 pb-1">
                    ...
                    <span className="tab tab-kategori block text-xs">Notifications</span>
                </Link>
                <Link to={"/login"} className="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center pt-2 pb-1">
                    <svg width="25" height="25" viewBox="0 0 42 42" className="inline-block mb-1">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <Link to={"#"} className="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center pt-2 pb-1">
                    ...
                    <span className="tab tab-whishlist block text-xs">Medicine</span>
                </Link>
                <div onClick={() => handleLogout()} className="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center pt-2 pb-1">
                    <LogOut className='mx-auto'/>
                    <span className="tab tab-account block text-xs">Logout</span>
                </div>
            </div>
        </section>
    )
