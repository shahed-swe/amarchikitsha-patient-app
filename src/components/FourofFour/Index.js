        ...
        <section className="px-4 py-32 mx-auto max-w-7xl">
            <div className="w-full mx-auto lg:w-1/3">
                ...
                <p className="mb-3 text-base font-medium text-gray-700">
                    The page you're looking for may have moved or no longer exists. Head back to our <Link href="#" className="underline">homepage</Link>, or take a look at one of the sections below.
                </p>
            </div>
        </section>
