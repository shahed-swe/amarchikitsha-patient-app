            ...
            <section className="bg-white">
                <div className="px-4 py-20 mx-auto max-w-7xl">
                    ...
                    <p className="mb-4 space-y-2 text-sm text-left text-gray-600 sm:text-center sm:space-y-0">
                        <Link to={"#"} className="w-full btn btn-sm btn-link sm:w-auto">Forgot password</Link>
                        <Link to={"#"} className="w-full btn btn-sm btn-link sm:w-auto">Create an account</Link>
                    </p>
                </div>
            </section>
